...
% rules
% 1. if the input is a pink rectangle, the output is a pink rectangle
% 2. if the input is a red rectangle, the output is a red rectangle
% 3. if the input is a blue rectangle, the output is a blue rectangle
% 4. if the input is a green rectangle, the output is a green rectangle
% 5. if the input is a yellow rectangle, the output is a yellow rectangle